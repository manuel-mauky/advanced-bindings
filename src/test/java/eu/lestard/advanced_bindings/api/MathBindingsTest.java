...
public class MathBindingsTest {
    ...
    public void testAcos() {
        testDoubleArgBinding(MathBindings::acos, Math::acos, 0, -1, 1, Double.NaN, 1.2);
    }


    @Test
    public void testAsin(){
        testDoubleArgBinding(MathBindings::asin, Math::asin, Math.PI, -Math.PI, 0, 1, -1, 1.45, Double.NaN);
    }

    @Test
    public void testAtan(){
        testDoubleArgBinding(MathBindings::atan, Math::atan, Math.PI, -Math.PI, 0, 1, -1, 1.45, Double.NaN);
    }
    ...
    public void testCbrt(){
        testDoubleArgBinding(MathBindings::cbrt, Math::cbrt, 0, -12.3, 12.3, Double.NaN, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);
    }

    @Test
    public void testCeil(){
        testDoubleArgBinding(MathBindings::ceil, Math::ceil, 0, 0.14, -0.14, 1, 14, 12.3, -12.4, Double.NaN, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);
    }
    ...
    @Test
    public void testCos(){
        testDoubleArgBinding(MathBindings::cos, Math::cos, 0, 1, -1, Math.PI, -Math.PI, Double.NaN);
    }

    @Test
    public void testCosh(){
        testDoubleArgBinding(MathBindings::cosh, Math::cosh, 0, 1, -1, Math.PI, -Math.PI, Double.NaN, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);
    }
    ...
    @Test
    public void testExp(){
        testDoubleArgBinding(MathBindings::exp, Math::exp, -1, 0, 1, 10, 13.402, Double.NaN, Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY);
    }

    @Test
    public void testExpm1(){
        testDoubleArgBinding(MathBindings::expm1, Math::expm1, -1, 0, 1, 10, 13.402, Double.NaN, Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY);
    }

    @Test
    public void testFloor(){
        testDoubleArgBinding(MathBindings::floor, Math::floor, -12.13, -1.23, -1, 0, 1, 1.23, 1.98, Double.NaN, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);
    }
    ...
    public void testGetExponent(){
        testDoubleArgBinding(MathBindings::getExponent, Math::getExponent, 2.1, 2.34, Double.NaN, Double.POSITIVE_INFINITY, 0);
    ...
    @Test
    public void testLog(){
        testDoubleArgBinding(MathBindings::log, Math::log, -12.3, -1, 0, 1, 12.3, Double.NaN, Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY);
    }

    @Test
    public void testLog10(){
        testDoubleArgBinding(MathBindings::log10, Math::log10, -12.3, -1, 0, 1, 12.3, 100, Double.NaN, Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY);
    }

    @Test
    public void testLog1p(){
        testDoubleArgBinding(MathBindings::log1p, Math::log1p, -12.3, -1, 0, 1, 12.3, Double.NaN, Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY);
    }
    ...
    public void testNextDown(){
        testDoubleArgBinding(MathBindings::nextDown, Math::nextDown, -12.3, -1, 0, 1, 12.3, Double.NaN, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);
    ...
    public void testNextUp(){
        testDoubleArgBinding(MathBindings::nextUp, Math::nextUp, -12.3, -1, 0, 1, 12.3, Double.NaN, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);
    ...
    public void testRint(){
        testDoubleArgBinding(MathBindings::rint, Math::rint, -1, 0, 1, 1.12, 1.89, 1.5, Double.NaN, Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY);
    }

    @Test
    public void testRound(){
        testDoubleArgBinding(MathBindings::round, Math::round, 1.34, 1.89, -12.34, -32.9, Double.NaN, 0);
        testFloatArgBinding(MathBindings::round, Math::round, 1.34f, 1.89f, -12.34f, -32.9f, Float.NaN, 0f);
    }

    @Test
    public void testSignum(){
        testDoubleArgBinding(MathBindings::signum, Math::signum, -1, -1.23, -0.23, 0, 0.23, -1.23, 1, Double.NaN);
    ...
    @Test
    public void testSin(){
        testDoubleArgBinding(MathBindings::sin, Math::sin, -1, 0, 1, Math.PI, -Math.PI, Double.NaN);
    }

    @Test
    public void testSinh(){
        testDoubleArgBinding(MathBindings::sinh, Math::sinh, -1, 0, 1, Math.PI, -Math.PI, Double.NaN);
    }

    @Test
    public void testSqrt(){
        testDoubleArgBinding(MathBindings::sqrt, Math::sqrt, -12, -10.34, -1, 0, 1, 10.34, 12, Double.NaN, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);
    }
    ...
    @Test
    public void testTan(){
        testDoubleArgBinding(MathBindings::tan, Math::tan, -1, 0, 1, Math.PI, -Math.PI, Double.NaN);
    }

    @Test
    public void testTanh(){
        testDoubleArgBinding(MathBindings::tanh, Math::tanh, -1, 0, 1, Math.PI, -Math.PI, Double.NaN);
    }

    @Test
    public void testToDegrees(){
        testDoubleArgBinding(MathBindings::toDegrees, Math::toDegrees, -1, 0, 1, 90, -90, 180, 360, 359, Double.NaN);
    }
    ...
    public void testToRadians(){
        testDoubleArgBinding(MathBindings::toRadians, Math::toRadians, -1, 0, 1, Math.PI, 2 * Math.PI, Double.NaN);
    }

    @Test
    public void testUlp(){
        testDoubleArgBinding(MathBindings::ulp, Math::ulp, 0, 1, 102.3, -102.3, Double.MAX_VALUE, Double.MIN_VALUE, Double.NaN, Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY);
